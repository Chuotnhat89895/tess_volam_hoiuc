...
void KItemList::GetWeaponDamage(int *nMin, int *nMax)
{
	...
	{
		_ASSERT(Item[nWeaponIdx].m_CommonAttrib.nItemGenre == item_equip && (Item[nWeaponIdx].m_CommonAttrib.nDetailType == equip_meleeweapon || Item[nWeaponIdx].m_CommonAttrib.nDetailType == equip_rangeweapon));
...
void KItemList::ExchangeItem(ItemPos *SrcPos, ItemPos *DesPos)
{
	...
	case pos_pgbox:
		...
		if (m_Hand)
		{
			...
			else if (SrcPos->nX == 3 || SrcPos->nX == 16)
			{
				...
				if (Item[m_Hand].GetGenre() != item_equip || Item[m_Hand].GetVersion() > 1 || !Item[m_Hand].IsItemMagic() || (Item[m_Hand].GetDetailType() != 2 && Item[m_Hand].GetDetailType() != 6 && Item[m_Hand].GetDetailType() != 5 && Item[m_Hand].GetDetailType() != 8 && Item[m_Hand].GetDetailType() != 7 && Item[m_Hand].GetDetailType() != 0 && Item[m_Hand].GetDetailType() != 1) || Item[m_Hand].m_SpecialParam.uItemType != 0)
				{
			...
			else if (SrcPos->nX == 14)
			{
				...
				if (Item[m_Hand].GetGenre() != item_equip || Item[m_Hand].GetVersion() > 1 || (Item[m_Hand].GetDetailType() != 2 && Item[m_Hand].GetDetailType() != 6 && Item[m_Hand].GetDetailType() != 5 && Item[m_Hand].GetDetailType() != 8 && Item[m_Hand].GetDetailType() != 7 && Item[m_Hand].GetDetailType() != 0 && Item[m_Hand].GetDetailType() != 1) || Item[m_Hand].m_SpecialParam.uItemType != 0)
				{
	...
	case pos_immediacy:
		...
		if (m_Hand)
		{
			if ((Item[m_Hand].GetGenre() == item_medicine || Item[m_Hand].GetGenre() == item_townportal || (Item[m_Hand].GetGenre() == item_task && !Item[m_Hand].IsStack())) && m_Room[room_immediacy].PlaceItem(DesPos->nX, DesPos->nY, m_Hand, Item[m_Hand].GetWidth(), Item[m_Hand].GetHeight()))
			{
				int nListIdx = FindSame(m_Hand);
